...
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  patient_heatmaps$non_collapsed$high_conf_bp
  patient_heatmaps$collapsed$high_conf_bp
```

#### All detections:
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  patient_heatmaps$non_collapsed$low_conf_bp
  patient_heatmaps$collapsed$low_conf_bp
```
<br />
