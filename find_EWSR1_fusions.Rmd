---
title: "Detected Ewing sarcoma mutations"
...
<!-- to knit document:
library(rmarkdown)
rmarkdown::render("/share/ScratchGeneral/jamtor/projects/ewing_ctDNA/scripts/find_EWSR1_fusions.Rmd", output_file="/share/ScratchGeneral/jamtor/projects/ewing_ctDNA/results/Rmarkdown/Ewing_sarcoma_mutation_report.html")
 -->
...
```{r, include = FALSE}
  ...
  ####################################################################################
  ### 3. Create longitudinal patient heatmap ###
  ####################################################################################
...
### Patient fusion detection heatmaps:
#### High confidence detections with false positives marked:
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  patient_heatmaps$non_collapsed$false_annot$high_conf_bp
  patient_heatmaps$collapsed$false_annot$high_conf_bp
```

#### All detections with false positives marked:
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  patient_heatmaps$non_collapsed$false_annot$low_conf_bp
  patient_heatmaps$collapsed$false_annot$low_conf_bp
```

### Patient fusion detection heatmaps:
#### High confidence detections with short variant VAFs marked:
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  patient_heatmaps$non_collapsed$false_annot$high_conf_bp
  patient_heatmaps$collapsed$false_annot$high_conf_bp
```

#### All detections with short variant VAFs marked:
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  patient_heatmaps$non_collapsed$short_variant_annot$low_conf_bp
  patient_heatmaps$collapsed$short_variant_annot$low_conf_bp
```
<br />

### Dilution fusion detection heatmaps:
#### High confidence detections:
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  dilution_heatmaps$non_collapsed$high_conf_bp
  dilution_heatmaps$collapsed$high_conf_bp
```

#### All detections:
```{r, fig.show="hold", out.width="50%", echo = FALSE}
  dilution_heatmaps$non_collapsed$low_conf_bp
  dilution_heatmaps$collapsed$low_conf_bp
```
<br />
...
```{r, echo = FALSE}
  kable(
    summary_tables$non_collapsed$patient,
    align = rep("c", ncol(summary_tables$non_collapsed$patient))
  )
  kable(
    summary_tables$collapsed$patient,
    align = rep("c", ncol(summary_tables$collapsed$patient))
  )
```
